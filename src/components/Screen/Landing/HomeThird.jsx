...
const HomeThird = () => {
  return (
    <div className="overflow-hidden h-[338px] glass-premium-bright rounded-3xl px-4 py-5 shadow-lg hide-scrollbar hover-gold-glow transition-all duration-300">
      <div className="relative h-[400px] overflow-auto hide-scrollbar">
        <p className="text-lg font-bold text-white whitespace-nowrap mb-2 premium-gold-text gold-glow-text">
          Blocks
        </p>
        {blocks.map((block, index) => (
          <div
            key={index}
            className="glass-premium rounded-3xl p-5 flex flex-row items-center space-x-6 shadow-lg mb-2 min-w-[400px] hover:scale-[1.02] hover-gold-glow transition-all duration-300"
          >
            <div className="flex-shrink-0">
              <img
                ...
                alt="animated-block"
                className="w-10 h-10 animate-rotate-slow-custom opacity-80"
              />
            </div>
            <div className="flex flex-row items-center justify-between w-full">
              <div>
                <a
                  className="pb-2 text-lg font-semibold text-gold-bright hover:text-gold-primary transition-colors duration-200"
                  href={block.link}
                >
                  {block.number}
                </a>
                <p className="pb-2 text-sm font-medium text-gold-bright opacity-80">
                  Reward: <span className="text-gold-primary font-bold">{block.reward}</span>
                </p>
                <a
                  className="text-nowrap bg-[#ffffff1a] hover:bg-[#ffffff33] transition px-4 py-2 rounded-lg text-sm font-medium text-white cursor-pointer shadow-md border border-gold-primary/30 hover:border-gold-bright/50"
              ...
              <div className="text-right">
                ...
                <div className="pb-2 flex items-center justify-end space-x-1">
                  <svg
                  ...
                  <p className="font-medium text-sm text-gold-primary">{block.pox}</p>
                </div>
