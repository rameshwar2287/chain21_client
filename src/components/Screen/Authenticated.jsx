...
import GenerationIncome from "../../screens/UserPanel/GenerationIncome";
import LeadershipIncome from "../../screens/UserPanel/LeadershipIncome";
import LifetimeIncome from "../../screens/UserPanel/LifetimeIncome";
import MentorIncome from "../../screens/UserPanel/MentorIncome";
import GlobalIncome from "../../screens/UserPanel/GlobalIncome";
...
import DirectReferralIncomeHistory from "../../screens/UserPanel/DirectReferralIncomeHistory";
      ...
      {role === "USER" ? (
        <Routes>
          ...
          >
            ...
            />
            <Route path={AuthenticatedUserRouters.GENERATION_INCOME_HISTORY} element={<GenerationIncome />} />
<Route path={AuthenticatedUserRouters.LEADERSHIP_INCOME_HISTORY} element={<LeadershipIncome />} />
<Route path={AuthenticatedUserRouters.LIFETIME_INCOME_HISTORY} element={<LifetimeIncome />} />
<Route path={AuthenticatedUserRouters.MENTOR_INCOME_HISTORY} element={<MentorIncome />} />
<Route path={AuthenticatedUserRouters.GLOBAL_INCOME_HISTORY} element={<GlobalIncome />} />
            <Route
            ...
            />
            <Route
              path={AuthenticatedUserRouters.DIRECT_REFERRAL_INCOME_HISTORY}
              element={<DirectReferralIncomeHistory />}
            />
            <Route
