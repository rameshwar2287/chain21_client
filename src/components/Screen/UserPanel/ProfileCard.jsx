...
const ProfileCard = () => {
  ...
  return (
    <div className="card hero-glass mt-10 rounded-2xl p-6 flex flex-col items-center h-full">
      <img
        src={
      ...
      />
      <h3 className="text-xl font-bold text-hero-primary mt-4">{user?.referralLink || "N/A"}</h3>
