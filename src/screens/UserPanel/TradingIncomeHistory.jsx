...
const TradingIncomeHistory = () => {
  ...
  const cardData = [
    ...
    },
    {
      ...
      value: `$ ${Number(totalIncome?.totalTradingIncome ?? 0).toFixed(2)}`,
    ...
    //   value: `${Number(totalIncome?.totalGlobalIncome?? 0).toFixed(2)}`,
    ...
    //   value: `$ ${Number(totalIncome?.totalLifetimeBonus ?? 0).toFixed(2)}`,
