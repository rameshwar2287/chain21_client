...
const MyEarningsPage = () => {
  ...
  const revenueOverview = [
    ...
    { title: 'Total Generation Income', value: `$ ${Number(totalIncome?.totalLevel ?? 0).toFixed(2)}`, icon: 'https://cdn-icons-png.flaticon.com/512/10102/10102408.png' },
    { title: 'Today Generation Income', value: `$ ${Number(totalIncome?.todayLevel ?? 0).toFixed(2)}`, icon: 'https://img.icons8.com/isometric/50/economic-improvement--v1.png' },
