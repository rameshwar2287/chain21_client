...
export const getAllUserDirectReferralIncomeHistory = async () => {
  try {
    const response = await Axios.get(`${userApi}/get-directreferral-history`);
    return response?.data;
  } catch (error) {
    return { success: false, message: error.message || "API error" };
  }
...
export const getAllUserIncomeHistory = async () => {
  try {
    ...
    console.log("Income history data:", response.data)
    return response?.data;
  } catch (error) {
    return { success: false, message: error.message || "API error" };
  }
...
export const updateProfile = async (payload) => {
  try {
    console.log("📤 API: Calling update-profile with:", payload);
...
export const walletDepositRequestBlockchain = async (payload) => {
  try {
    const response = await Axios.post(
      `${userApi}/tx/deposit-amount-wallet-blockchain`,
      payload
    );
    return response?.data;
  } catch (error) {
